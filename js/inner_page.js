...
$.validator.addMethod("phone", function(phone_number, element) {
	...
	return this.optional(element) || phone_number.length > 9 &&
		phone_number.match(/^((8|\+7)-?)?\(?\d{3}\)?-?\d{1}-?\d{1}-?\d{1}-?\d{1}-?\d{1}-?\d{1}-?\d{1}$/);
...
var
	...
	setTopBarSliderElements = function($source) {
		var
...
$(document).ready(function() {
	...
	$('#fullpage').fullpage({
		...
		normalScrollElements: '.section-content, .gallery-list',
		anchors: [
			'page_content',
			'additional_info'
		],
		...
		afterResize: function() {
			setSizes();
			$(".js-gallery-previews, .js-gallery-previews-shadow").each(function() {
